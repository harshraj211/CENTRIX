...
function createNapiModule(options) {
  var napiModule = (function () {
    ...
    var PThread = new wasiThreads.ThreadManager(
      ...
      cancelWork: function (work) {
        ...
        emnapiAWMT.getMutex().execute(function () {
          ...
          cancelled =
            ...
            HEAP_DATA_VIEW.getInt32(work + emnapiAWMT.offset.status, true) !== 2
          if (cancelled) {
...
function loadNapiModuleImpl(loadFn, userNapiModule, wasmInput, options) {
  ...
  if (wasi) {
    wasiThreads$1 = new wasiThreads.WASIThreads(
...
class MessageHandler extends wasiThreads.ThreadMessageHandler {
  constructor(options) {
    ...
    super({
      ...
      onError: (err, type) => {
        var _a
        const emnapi_thread_crashed =
          (_a = this.instance) === null || _a === void 0
            ? void 0
