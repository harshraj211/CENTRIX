  ...
  var napiModule = (function () {
    ...
    function napi_release_threadsafe_function(func, mode) {
      ...
      var ret = mutex.execute(function () {
        ...
        if (
          emnapiTSFN.getThreadCount(func) === 0 ||
          mode === 1 /* napi_threadsafe_function_release_mode.napi_tsfn_abort */
        ) {
          if (emnapiTSFN.getState(func) === 0 /* State.kOpen */) {
            if (
              mode ===
        ...
        if (length <= 16) {
          ...
          while (idx < end) {
            ...
            if ((u0 & 0xf0) === 0xe0) {
              ...
              u0 =
                ((u0 & 7) << 18) | (u1 << 12) | (u2 << 6) | (HEAPU8[idx++] & 63)
            }
            if (u0 < 0x10000) {
              str += String.fromCharCode(u0)
            } else {
      ...
      if (getter || setter) {
        ...
        var desc = {
          configurable:
            ...
            0,
          enumerable:
            (attributes & 2) /* napi_property_attributes.napi_enumerable */ !==
            0,
          get: localGetter,
          set: localSetter,
        }
        ...
        var desc = {
          ...
          enumerable:
            ...
            0,
          writable:
            (attributes & 1) /* napi_property_attributes.napi_writable */ !== 0,
          value: localMethod,
        }
        Object.defineProperty(obj, propertyName, desc)
      } else {
    ...
    function napi_define_class(
      ...
      try {
        ...
        if (
          !((length >= -1 && length <= 2147483647) || length === 4294967295) ||
          !utf8name
        ) {
          return envObject.setLastError(1 /* napi_status.napi_invalid_arg */)
        }
