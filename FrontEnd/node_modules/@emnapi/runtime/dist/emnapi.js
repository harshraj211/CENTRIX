;(function (global, factory) {
  ...
  var canSetFunctionName = /*#__PURE__*/ (function () {
    ...
    try {
      return Boolean(
        (_a = Object.getOwnPropertyDescriptor(Function.prototype, "name")) ===
          null || _a === void 0
          ? void 0
          : _a.configurable,
      )
  ...
  var Handle = /*#__PURE__*/ (function () {
    ...
    Handle.prototype.isBuffer = function (BufferConstructor) {
      ...
      return (
        ...
        BufferConstructor.isBuffer(this.value)
      )
    }
  ...
  var HandleStore = /*#__PURE__*/ (function () {
    ...
    HandleStore.UNDEFINED = new ConstHandle(
      1 /* GlobalHandle.UNDEFINED */,
      undefined,
    )
  ...
  var Env = /*#__PURE__*/ (function () {
    ...
    Env.prototype.setLastError = function (
      error_code,
      engine_error_code,
      engine_reserved,
    ) {
    ...
    Env.prototype.checkGCAccess = function () {
      if (
        this.moduleApiVersion === NAPI_VERSION_EXPERIMENTAL &&
        this.inGcFinalizer
      ) {
        this.abort(
    ...
    Env.prototype.setInstanceData = function (
      data,
      finalize_cb,
      finalize_hint,
    ) {
      ...
      this.instanceData = TrackedFinalizer.create(
        this,
        finalize_cb,
        data,
        finalize_hint,
  ...
  var NodeEnv = /*#__PURE__*/ (function (_super) {
    ...
    NodeEnv.prototype.canCallIntoJs = function () {
      return (
        _super.prototype.canCallIntoJs.call(this) && this.ctx.canCallIntoJs()
      )
    }
    ...
    NodeEnv.prototype.callbackIntoModule = function (
    ...
    NodeEnv.prototype.callFinalizerInternal = function (
      forceUncaught,
      cb,
      data,
      hint,
  ...
  var ReferenceWithData = /*#__PURE__*/ (function (_super) {
    ...
    function ReferenceWithData(
      ...
      var _this =
        _super.call(this, envObject, value, initialRefcount, ownership) || this
      _this._data = _data
      return _this
    }
    ReferenceWithData.create = function (
      envObject,
      value,
      initialRefcount,
      ownership,
  ...
  var ExternalMemory = /*#__PURE__*/ (function () {
    ...
    ExternalMemory.prototype.adjust = function (changeInBytes) {
      ...
      if (
        !(
          kMinReasonableBytes <= changeInBytes &&
          changeInBytes < kMaxReasonableBytes
        )
      ) {
        throw new RangeError(
          "changeInBytes ".concat(changeInBytes, " is out of reasonable range"),
        )
      }
      var old = this.total
    ...
    CleanupQueue.prototype.add = function (envObject, fn, arg) {
      if (
        this._cleanupHooks.filter(function (hook) {
          return (
            hook.envObject === envObject && hook.fn === fn && hook.arg === arg
          )
        }).length > 0
      ) {
  ...
  var Context = /*#__PURE__*/ (function () {
    function Context(options) {
      ...
      this._externalMemory = new ExternalMemory(
        options === null || options === void 0
          ? void 0
          : options.onExternalMemoryChange,
      )
      if (
        typeof process === "object" &&
        process !== null &&
    ...
    Context.prototype.adjustAmountOfExternalAllocatedMemory = function (
      changeInBytes,
    ) {
