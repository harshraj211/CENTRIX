...
export declare function createInstanceProxy(
...
export declare function createNapiModule(options: CreateOptions): NapiModule
...
export declare interface LoadedSource
  extends WebAssembly.WebAssemblyInstantiatedSource {
...
export declare interface MainThreadOptionsCreateThreadManager
  extends MainThreadBaseOptions,
    ThreadManagerOptionsMain {}

/** @public */

export declare interface MainThreadOptionsWithThreadManager
  extends MainThreadBaseOptions {
...
export declare class MessageHandler extends ThreadMessageHandler {
  ...
  instantiate(
    data: LoadPayload,
  ): InstantiatedSource | PromiseLike<InstantiatedSource>
...
export declare interface MessageHandlerOptions
  extends ThreadMessageHandlerOptions {
  onLoad: (
    data: LoadPayload,
  ) => InstantiatedSource | PromiseLike<InstantiatedSource>
}
...
export declare class ThreadManager {
  ...
  addMessageEventListener(
    worker: WorkerLike,
    onMessage: (e: WorkerMessageEvent) => void,
  ): () => void
...
export declare interface ThreadManagerOptionsChild
  extends ThreadManagerOptionsBase {
  childThread: true
}

/** @public */

export declare interface ThreadManagerOptionsMain
  extends ThreadManagerOptionsBase {
...
export declare class ThreadMessageHandler {
  ...
  protected onLoad?: (
    data: LoadPayload,
  ) => WebAssembly.WebAssemblyInstantiatedSource | PromiseLike<WebAssembly.WebAssemblyInstantiatedSource>
  ...
  protected _loaded(
    err: Error | null,
    source: WebAssembly.WebAssemblyInstantiatedSource | null,
    payload: LoadPayload,
  ): void

  protected handleAfterLoad<E extends WorkerMessageEvent,>(
    e: E,
    f: (e: E) => void,
  ): void
}
