...
export declare class Asyncify {
  ...
  init<T extends WebAssembly.Exports,
  ...
  wrapExports<T extends WebAssembly.Exports,>(
    exports: T,
  ): AsyncifyExports<T, void>
...
export declare type AsyncifyExportFunction<T,> = T extends Callable
...
export declare type AsyncifyExports<T,
...
export declare function asyncifyLoad(
...
export declare function asyncifyLoadSync(
  asyncify: AsyncifyOptions,
...
export declare function createAsyncWASI(
  options?: AsyncWASIOptions,
): Promise<WASI>
...
export declare interface IFs {
  ...
  readlinkSync(
    path: PathLike,
    options?: BaseEncodingOptions | BufferEncoding_2,
  ): string
  ...
  readlinkSync(
    path: PathLike,
    options?: BaseEncodingOptions | string,
  ): string | Uint8Array
...
export declare type PromisifyExports<T,
U,> = T extends Record<string, any>
  ? {
    [P in keyof T]: T[P] extends Callable
...
export declare class WASI {
  ...
  finalizeBindings(
    ...
    { memory }?: FinalizeBindingsOptions,
  ): void

  start(
    instance: WebAssembly.Instance,
  ): number | undefined | Promise<number> | Promise<undefined>
...
export declare function wrapAsyncExport<T extends Function = any>(
  f: Function,
): T

/** @public */

export declare function wrapAsyncImport<T extends (...args: any[]) => any>(
  f: T,
...
export declare function wrapExports<T extends WebAssembly.Exports>(
  exports: T,
): PromisifyExports<T, void>

/** @public */

export declare function wrapExports<T extends WebAssembly.Exports,
U extends Array<keyof T>,>(exports: T, needWrap: U): PromisifyExports<T, U>
