  ...
  constructor(args, env, fds, asyncFs, fs, asyncify) {
    ...
    defineImport(
      ...
      function path_filestat_set_times(
        ...
        if (
          (fst_flags & WasiFstFlag.SET_ATIM_NOW) ===
          WasiFstFlag.SET_ATIM_NOW
        ) {
          atim = BigInt(Date.now() * 1000000)
        }
        if (
          (fst_flags & WasiFstFlag.SET_MTIM_NOW) ===
          WasiFstFlag.SET_MTIM_NOW
        ) {
          mtim = BigInt(Date.now() * 1000000)
        }
    ...
    function pathOpen(o_flags, fs_rights_base, fs_rights_inheriting, fs_flags) {
      ...
      let flags = write
        ? read
          ? FileControlFlag.O_RDWR
          : FileControlFlag.O_WRONLY
        : FileControlFlag.O_RDONLY
      ...
      if (
        write &&
        (flags & (FileControlFlag.O_APPEND | FileControlFlag.O_TRUNC)) === 0
      ) {
