...
export declare function __classPrivateFieldGet<T extends new (
  ...args: any[]
) => unknown,
V,>(
  receiver: T,
...
export declare function __classPrivateFieldGet<T extends object,
...
export declare function __classPrivateFieldSet<T extends new (
  ...args: any[]
) => unknown,
V,>(
  receiver: T,
