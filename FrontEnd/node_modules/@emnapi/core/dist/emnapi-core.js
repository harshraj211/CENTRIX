;(function (global, factory) {
  ...
  function load(wasmInput, imports) {
    ...
    if (wasmInput instanceof _WebAssembly$1.Module) {
      return _WebAssembly$1
        .instantiate(wasmInput, imports)
    ...
    if (
      inputIsString ||
      (typeof URL !== "undefined" && wasmInput instanceof URL)
    ) {
      if (
        inputIsString &&
        typeof wx !== "undefined" &&
  ...
  function deserizeErrorFromBuffer(sab) {
    ...
    var messageBuffer = buffer.slice(
      16 + nameLength,
  ...
  var ThreadManager = /*#__PURE__*/ (function () {
    function ThreadManager(options) {
      ...
      this.printErr =
        (_a = options.printErr) !== null && _a !== void 0
          ? _a
    ...
    ThreadManager.prototype.shouldPreloadWorkers = function () {
      return (
        !this._childThread && this._reuseWorker && this._reuseWorker.size > 0
      )
    }
    ThreadManager.prototype.loadWasmModuleToAllWorkers = function () {
      ...
      var _loop_1 = function (i) {
        ...
        promises[i] = this_1.loadWasmModuleToWorker(worker).then(
          function (w) {
      ...
      worker.whenLoaded = new Promise(function (resolve, reject) {
        var handleError = function (e) {
          ...
          if (worker.__emnapi_tid !== undefined) {
            message =
              "worker (tid = " + worker.__emnapi_tid + ") sent an error!"
          }
          if ("message" in e) {
    ...
    ThreadManager.prototype.terminateWorker = function (worker) {
      ...
      // eslint-disable-next-line @typescript-eslint/no-floating-promises
      worker.terminate()
      ;(_a = this.messageEvents.get(worker)) === null || _a === void 0
        ? void 0
        : _a.clear()
    ...
    ThreadManager.prototype.addMessageEventListener = function (
      worker,
      onMessage,
    ) {
  ...
  function createInstanceProxy(instance, memory) {
    ...
    handler.get = function (_target, p, receiver) {
      var _a
      if (p === "memory") {
        return (_a = typeof memory === "function" ? memory() : memory) !==
          null && _a !== void 0
          ? _a
  ...
  var WASIThreads = /*#__PURE__*/ (function () {
    function WASIThreads(options) {
      ...
      var threadSpawn = function (startArg, errorOrTid) {
        ...
        try {
          ...
          if (isNewABI) {
            var struct_1 = new Int32Array(
              _this_1.wasmMemory.buffer,
              errorOrTid,
              2,
            )
    ...
    WASIThreads.prototype.setup = function (
      wasmInstance,
      wasmModule,
      wasmMemory,
    ) {
    ...
    WASIThreads.prototype.terminateAllThreads = function () {
      var _a
      if (!this.childThread) {
        ;(_a = this.PThread) === null || _a === void 0
          ? void 0
          : _a.terminateAllThreads()
      } else {
  ...
  var ThreadMessageHandler = /*#__PURE__*/ (function () {
    function ThreadMessageHandler(options) {
      ...
      this.onLoad =
        options === null || options === void 0 ? void 0 : options.onLoad
      this.onError =
    ...
    ThreadMessageHandler.prototype.handle = function (e) {
      ...
      var _a
      if (
        (_a = e === null || e === void 0 ? void 0 : e.data) === null ||
        _a === void 0
          ? void 0
          : _a.__emnapi__
      ) {
  ...
  function createNapiModule(options) {
    var napiModule = (function () {
      ...
      var napiModule = {
        ...
        init: function (options) {
          ...
          if (!napiModule.childThread) {
            ...
            var envObject =
              napiModule.envObject ||
              (napiModule.envObject = emnapiCtx.createEnv(
                napiModule.filename,
                moduleApiVersion,
                function (cb) {
            ...
            try {
              envObject.callIntoModule(function (_envObject) {
                ...
                var napi_register_wasm_v1 =
                  instance.exports.napi_register_wasm_v1
                var napiValue = napi_register_wasm_v1(
                  _envObject.id,
                  exportsHandle.id,
                )
      ...
      napiModule.imports.env._emnapi_async_work_pool_size =
       ...
       * @__sig vipppp
       */
      function _emnapi_call_finalizer(
        forceUncaught,
        env,
        callback,
        data,
      ...
      /** @__sig ipjp */
      function napi_adjust_external_memory(
        env,
        change_in_bytes,
        adjusted_value,
      ) {
        ...
        var adjusted_memory =
          emnapiCtx.adjustAmountOfExternalAllocatedMemory(change_in_bytes)
        adjusted_value >>>= 0
        if (emnapiCtx.feature.supportBigInt) {
          var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
          HEAP_DATA_VIEW.setBigInt64(
            adjusted_value,
            BigInt(adjusted_memory),
            true,
          )
        } else {
      ...
      var emnapiAWST = {
        ...
        queue: function (id) {
          ...
          if (work.status === 0) {
            work.status = 1
            if (
              emnapiAWST.queued.size >= (Math.abs(emnapiAsyncWorkPoolSize) || 4)
            ) {
      ...
      /** @__sig ippp */
      function _emnapi_async_init_js(
        async_resource,
        async_resource_name,
        result,
      ) {
      ...
      function napi_make_callback(
        ...
        if (!envObject.canCallIntoJs())
          return envObject.setLastError(
            envObject.moduleApiVersion >= 10
              ? 23 /* napi_status.napi_cannot_run_js */
              : 10 /* napi_status.napi_pending_exception */,
          )
        ...
        try {
          if (!emnapiNodeBinding) {
            return envObject.setLastError(
              9 /* napi_status.napi_generic_failure */,
            )
          }
          if (!recv)
            return envObject.setLastError(1 /* napi_status.napi_invalid_arg */)
          if (argc > 0) {
            if (!argv)
              return envObject.setLastError(
                1 /* napi_status.napi_invalid_arg */,
              )
          }
          ...
          var ret = emnapiNodeBinding.napi.makeCallback(
            ctx,
            v8recv,
            v8func,
            arr,
      ...
      var emnapiTSFN = {
          ...
          var handler = function (e) {
            ...
            if (__emnapi__) {
              ...
              if (type === "tsfn-send") {
                ...
                if (
                  Atomics.load(
                    new Int32Array(emnapiTSFN.ensureBufferFor(pendng + 4)),
                    pendng >>> 2,
                  ) !== 0
                ) {
        ...
        initQueue: function (func) {
          ...
          queue >>>= 0
          new Uint8Array(
            emnapiTSFN.ensureBufferFor(queue + size),
            queue,
            size,
          ).fill(0)
        ...
        destroyQueue: function (func) {
          var queue = emnapiTSFN.loadSizeTypeValue(
            func + emnapiTSFN.offset.queue,
            false,
          )
          if (queue) {
        ...
        push: function (func, data, mode) {
          ...
          var waitCondition = function () {
            ...
            return (
              queueSize >= maxSize &&
              maxSize > 0 &&
              emnapiTSFN.getState(func) === 0 /* State.kOpen */
            )
          }
          var isBrowserMain =
          ...
          var ret = mutex.execute(function () {
            while (waitCondition()) {
              if (
                mode ===
                0 /* napi_threadsafe_function_call_mode.napi_tsfn_nonblocking */
              ) {
            ...
            if (
              !(
                emnapiTSFN.getState(func) === 2 /* State.kClosed */ &&
                emnapiTSFN.getThreadCount(func) === 0
              )
            ) {
          ...
          var mutex = {
            lock: function () {
              ...
              var i32a = new Int32Array(
                emnapiTSFN.ensureBufferFor(index + 4),
                index,
                1,
              )
              if (isBrowserMain) {
        ...
        getQueueSize: function (func) {
          return emnapiTSFN.loadSizeTypeValue(
            func + emnapiTSFN.offset.queue_size,
            true,
          )
        },
        ...
        getThreadCount: function (func) {
          return emnapiTSFN.loadSizeTypeValue(
            func + emnapiTSFN.offset.thread_count,
            true,
          )
        },
        ...
        getState: function (func) {
          return Atomics.load(
            new Int32Array(
              emnapiTSFN.ensureBufferFor(func + emnapiTSFN.offset.state + 4),
            ),
            (func + emnapiTSFN.offset.state) >>> 2,
          )
        },
          ...
          return Atomics.load(
            new Int8Array(
              emnapiTSFN.ensureBufferFor(
                func + emnapiTSFN.offset.handles_closing + 1,
              ),
            ),
        ...
        getDispatchState: function (func) {
          return Atomics.load(
            new Uint32Array(
              emnapiTSFN.ensureBufferFor(
                func + emnapiTSFN.offset.dispatch_state + 4,
              ),
            ),
        ...
        getContext: function (func) {
          return emnapiTSFN.loadSizeTypeValue(
            func + emnapiTSFN.offset.context,
            false,
          )
        },
        getMaxQueueSize: function (func) {
          return emnapiTSFN.loadSizeTypeValue(
            func + emnapiTSFN.offset.max_queue_size,
            true,
          )
        },
        getEnv: function (func) {
          return emnapiTSFN.loadSizeTypeValue(
            func + emnapiTSFN.offset.env,
            false,
          )
        },
        getCallJSCb: function (func) {
          return emnapiTSFN.loadSizeTypeValue(
            func + emnapiTSFN.offset.call_js_cb,
            false,
          )
        },
        getRef: function (func) {
          return emnapiTSFN.loadSizeTypeValue(
            func + emnapiTSFN.offset.ref,
            false,
          )
        },
        getResource: function (func) {
          return emnapiTSFN.loadSizeTypeValue(
            func + emnapiTSFN.offset.resource,
            false,
          )
        },
        getFinalizeCb: function (func) {
          return emnapiTSFN.loadSizeTypeValue(
            func + emnapiTSFN.offset.finalize_cb,
            false,
          )
        },
        getFinalizeData: function (func) {
          return emnapiTSFN.loadSizeTypeValue(
            func + emnapiTSFN.offset.finalize_data,
            false,
          )
        },
        ...
        releaseResources: function (func) {
          if (emnapiTSFN.getState(func) !== 2 /* State.kClosed */) {
            ...
            var arr = new Uint32Array(
              emnapiTSFN.ensureBufferFor(asyncRefAddress + 4),
            )
            ...
            if (emnapiNodeBinding) {
              var view = new DataView(
                emnapiTSFN.ensureBufferFor(
                  func + emnapiTSFN.offset.trigger_async_id + 8,
                ),
              )
              var asyncId = view.getFloat64(
          ...
          try {
            ...
            if (finalize) {
              if (emnapiNodeBinding) {
                ...
                var resourceObject =
                  emnapiCtx.handleStore.get(resource_value).value
                var view = new DataView(
                  emnapiTSFN.ensureBufferFor(
                    func + emnapiTSFN.offset.trigger_async_id + 8,
                  ),
        ...
        closeHandlesAndMaybeDelete: function (func, set_closing) {
          ...
          try {
            ...
            Atomics.store(
              new Int32Array(
                emnapiTSFN.ensureBufferFor(
                  func + emnapiTSFN.offset.async_pending + 4,
                ),
              ),
              (func + emnapiTSFN.offset.async_pending) >>> 2,
              1,
            )
            emnapiCtx.feature.setImmediate(function () {
        ...
        dispatch: function (func) {
          ...
          var ui32a = new Uint32Array(
            emnapiTSFN.ensureBufferFor(dispatchStateAddress + 4),
          )
        ...
        enqueue: function (func) {
          ...
          var i32a = new Int32Array(
            emnapiTSFN.ensureBufferFor(Math.max(pending, scheduled) + 4),
          )
      ...
      function napi_create_threadsafe_function(
        ...
        if (!func) {
          ...
          ref = emnapiCtx.createReference(
            ...
            func,
            1,
            1 /* ReferenceOwnership.kUserland */,
          ).id
        }
        ...
        if (async_resource) {
          ...
          if (asyncResourceObject == null) {
            return envObject.setLastError(
              2 /* napi_status.napi_object_expected */,
            )
          }
        ...
        var asyncResourceName =
          emnapiCtx.handleStore.get(async_resource_name).value
        if (typeof asyncResourceName === "symbol") {
          return envObject.setLastError(
            3 /* napi_status.napi_string_expected */,
          )
        }
        ...
        tsfn >>>= 0
        new Uint8Array(emnapiTSFN.ensureBufferFor(tsfn + sizeofTSFN))
          .subarray(tsfn, tsfn + sizeofTSFN)
          .fill(0)
        ...
        HEAP_DATA_VIEW.setUint32(
          tsfn + emnapiTSFN.offset.resource,
          resource_,
          true,
        )
        ...
        HEAP_DATA_VIEW.setUint32(
          tsfn + emnapiTSFN.offset.context,
          context,
          true,
        )
        HEAP_DATA_VIEW.setUint32(
        ...
        HEAP_DATA_VIEW.setUint32(
          tsfn + emnapiTSFN.offset.call_js_cb,
          call_js_cb,
          true,
        )
      ...
      function napi_release_threadsafe_function(func, mode) {
        ...
        var ret = mutex.execute(function () {
          ...
          if (
            emnapiTSFN.getThreadCount(func) === 0 ||
            mode ===
              1 /* napi_threadsafe_function_release_mode.napi_tsfn_abort */
          ) {
            if (emnapiTSFN.getState(func) === 0 /* State.kOpen */) {
              if (
                mode ===
              ...
              if (
                emnapiTSFN.getState(func) === 1 /* State.kClosing */ &&
                emnapiTSFN.getMaxQueueSize(func) > 0
              ) {
                cond.signal()
              }
              emnapiTSFN.send(func)
      ...
      var emnapiAWMT = {
        ...
        initGlobal: function () {
          if (!emnapiAWMT.globalAddress) {
            ...
            new Uint8Array(
              emnapiAWMT.ensureBufferFor(addr + size),
              addr,
              size,
            ).fill(0)
            emnapiAWMT.queueInit(
              emnapiAWMT.globalAddress + emnapiAWMT.globalOffset.q,
            )
            emnapiAWMT.queueInit(
              emnapiAWMT.globalAddress + emnapiAWMT.globalOffset.exit_message,
            )
          }
        },
        terminateWorkers: function () {
          emnapiAWMT.pool.forEach(function (w) {
            var _a, _b
            ;(_a = w._emnapiAWMTListener) === null || _a === void 0
              ? void 0
              : _a.dispose()
            ;(_b = w._emnapiTSFNListener) === null || _b === void 0
              ? void 0
              : _b.dispose()
            w.terminate()
          })
        ...
        initWorkers: function (n) {
          if (ENVIRONMENT_IS_PTHREAD) {
            ...
            return (
              ...
              (emnapiAWMT.workerReady = Promise.resolve())
            )
          }
          ...
          var emnapi_async_worker_create =
            wasmInstance.exports.emnapi_async_worker_create
          var args = []
          ...
          var promises = args.map(function (index) {
            ...
            var tidOffset = 20
            var view = new DataView(
              emnapiAWMT.ensureBufferFor(index + tidOffset + 4),
            )
        ...
        getResource: function (work) {
          ...
          var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
          return HEAP_DATA_VIEW.getUint32(
            work + emnapiAWMT.offset.resource,
            true,
          )
        },
        getExecute: function (work) {
          ...
          var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
          return HEAP_DATA_VIEW.getUint32(
            work + emnapiAWMT.offset.execute,
            true,
          )
        },
        getComplete: function (work) {
          ...
          var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
          return HEAP_DATA_VIEW.getUint32(
            work + emnapiAWMT.offset.complete,
            true,
          )
        },
          ...
          var mutex = {
            lock: function () {
              var isBrowserMain =
                ...
                !ENVIRONMENT_IS_NODE
              var i32a = new Int32Array(
                emnapiAWMT.ensureBufferFor(index + 4),
                index,
                1,
              )
              if (isBrowserMain) {
        ...
        scheduleWork: function (work) {
          var _a
          if (
            !((_a = emnapiAWMT.workerReady) === null || _a === void 0
              ? void 0
              : _a.ready)
          ) {
            emnapiAWMT
              .initWorkers(_emnapi_async_work_pool_size())
              .then(function () {
          ...
          emnapiCtx.increaseWaitingRequestCounter()
          var statusBuffer = new Int32Array(
            emnapiAWMT.ensureBufferFor(work + emnapiAWMT.offset.status + 4),
            work + emnapiAWMT.offset.status,
            1,
          )
          ...
          mutex.lock()
          try {
            emnapiAWMT.queueInsertTail(
              emnapiAWMT.globalAddress + emnapiAWMT.globalOffset.q,
              work + emnapiAWMT.offset.queue,
            )
          } catch (err) {
            emnapiCtx.decreaseWaitingRequestCounter()
            mutex.unlock()
          ...
          emnapiAWMT.ensureBufferFor(
            emnapiAWMT.globalAddress + emnapiAWMT.globalOffset.idle_threads + 4,
          )
          var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
          if (
            HEAP_DATA_VIEW.getUint32(
              emnapiAWMT.globalAddress + emnapiAWMT.globalOffset.idle_threads,
              true,
            ) > 0
          ) {
            cond.signal()
        ...
        cancelWork: function (work) {
          ...
          emnapiAWMT.getMutex().execute(function () {
            ...
            var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
            cancelled =
              !emnapiAWMT.queueEmpty(work + emnapiAWMT.offset.queue) &&
              HEAP_DATA_VIEW.getInt32(work + emnapiAWMT.offset.status, true) !==
                2 /* AsyncWorkStatus.Completed */
            if (cancelled) {
          ...
          if (
            Atomics.compareExchange(
              ...
              0,
              0 /* AsyncWorkStatus.Pending */,
              1 /* AsyncWorkStatus.Cancelled */,
            ) !== 0 /* AsyncWorkStatus.Pending */
          ) {
            return 9 /* napi_status.napi_generic_failure */
          }
        ...
        callComplete: function (work, status) {
          ...
          try {
            if (emnapiNodeBinding) {
              ...
              var view = new DataView(
                emnapiAWMT.ensureBufferFor(
                  work + emnapiAWMT.offset.trigger_async_id + 8,
                ),
              )
              var asyncId = view.getFloat64(
                work + emnapiAWMT.offset.async_id,
                true,
              )
              var triggerAsyncId = view.getFloat64(
              ...
              emnapiNodeBinding.node.makeCallback(
                resourceObject,
                callback,
                [],
                {
      ...
      var napi_create_async_work = singleThreadAsyncWork
        ? function (
            ...
            var resourceName = String(
              emnapiCtx.handleStore.get(resource_name).value,
            )
            // eslint-disable-next-line @typescript-eslint/no-unused-vars
        ...
        : function (
            ...
            aw >>>= 0
            new Uint8Array(emnapiAWMT.ensureBufferFor(aw + sizeofAW))
              .subarray(aw, aw + sizeofAW)
              .fill(0)
            ...
            HEAP_DATA_VIEW.setUint32(
              aw + emnapiAWMT.offset.execute,
              execute,
              true,
            )
            HEAP_DATA_VIEW.setUint32(
              aw + emnapiAWMT.offset.complete,
              complete,
              true,
            )
      ...
      function _emnapi_async_worker(globalAddress) {
        ...
        mutex.lock()
        var exitMessageAddr =
          globalAddress + emnapiAWMT.globalOffset.exit_message
        var idleThreadsAddr =
        ...
        for (;;) {
          ...
          while (emnapiAWMT.queueEmpty(workerQueueAddr)) {
            Atomics.add(
              new Int32Array(
                emnapiAWMT.ensureBufferFor(idleThreadsAddr + 4),
                idleThreadsAddr,
                1,
              ),
              0,
          ...
          if (
            Atomics.load(statusBuffer, 0) === 1 /* AsyncWorkStatus.Cancelled */
          ) {
            abort("unreachable")
          }
          // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      function initWorker(startArg, func) {
        if (napiModule.childThread) {
          if (
            typeof wasmInstance.exports.emnapi_async_worker_init !== "function"
          ) {
            throw new TypeError(
      ...
      var emnapiExternalMemory = {
        ...
        getArrayBufferPointer: function (arrayBuffer, shouldCopy) {
          ...
          if (emnapiExternalMemory.table.has(arrayBuffer)) {
            ...
            if (
              shouldCopy &&
              cachedInfo.ownership === 0 /* ReferenceOwnership.kRuntime */ &&
          ...
          info.ownership = emnapiExternalMemory.registry
            ? 0 /* ReferenceOwnership.kRuntime */
            : 1 /* ReferenceOwnership.kUserland */
        ...
        getOrUpdateMemoryView: function (view) {
          if (view.buffer === wasmMemory.buffer) {
            if (!emnapiExternalMemory.wasmMemoryViewTable.has(view)) {
              emnapiExternalMemory.wasmMemoryViewTable.set(view, {
                ...
                length:
                  view instanceof DataView ? view.byteLength : view.length,
          ...
          var maybeOldWasmMemory =
            ...
            emnapiExternalMemory.isSharedArrayBuffer(view.buffer)
          if (
            maybeOldWasmMemory &&
      ...
      var emnapiExternalSAB = {
        ...
        release: function (metaPtr) {
          var oldRefcount = Atomics.sub(
            new Int32Array(wasmMemory.buffer, metaPtr, 1),
            0,
            1,
          )
          if (oldRefcount === 1) {
      ...
      function napi_get_array_length(env, value, result) {
        ...
        try {
          ...
          if (!handle.isArray()) {
            return envObject.setLastError(
              8 /* napi_status.napi_array_expected */,
            )
          }
          result >>>= 0
          // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      function napi_get_arraybuffer_info(env, arraybuffer, data, byte_length) {
        ...
        if (data) {
          data >>>= 0
          // eslint-disable-next-line @typescript-eslint/no-unused-vars
          var p = emnapiExternalMemory.getArrayBufferPointer(
            handle.value,
            true,
          ).address
      ...
      function napi_get_prototype(env, value, result) {
        ...
        try {
          ...
          try {
            v =
              handle.isObject() || handle.isFunction()
                ? handle.value
                : Object(handle.value)
          } catch (_) {
            return envObject.setLastError(
      ...
      function napi_get_value_bool(env, value, result) {
        ...
        if (typeof handle.value !== "boolean") {
          return envObject.setLastError(
            7 /* napi_status.napi_boolean_expected */,
          )
        }
        result >>>= 0
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      function napi_get_value_double(env, value, result) {
        ...
        if (typeof handle.value !== "number") {
          return envObject.setLastError(
            6 /* napi_status.napi_number_expected */,
          )
        }
        result >>>= 0
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      function napi_get_value_bigint_words(
        ...
        if (!handle.isBigInt()) {
          return envObject.setLastError(
            17 /* napi_status.napi_bigint_expected */,
          )
        }
      ...
      function napi_get_value_int64(env, value, result) {
        ...
        if (
          ...
          numberValue < /* INT64_RANGE_NEGATIVE */ -9223372036854776e3
        ) {
          HEAP_DATA_VIEW.setInt32(result, 0, true)
          HEAP_DATA_VIEW.setInt32(result + 4, 2147483648, true)
        } else if (
          numberValue >= /* INT64_RANGE_POSITIVE */ 9223372036854776000
        ) {
      ...
      function napi_get_value_string_utf16(env, value, buf, buf_size, result) {
        ...
        if (!buf) {
          ...
          // eslint-disable-next-line @typescript-eslint/no-unused-vars
          var copied = emnapiString.stringToUTF16(
            handle.value,
            buf,
            buf_size * 2,
          )
      ...
      function napi_create_string_latin1(env, str, length, result) {
        return emnapiString.newString(
          ...
          length,
          result,
          function (str, autoLength, sizeLength) {
            var latin1String = ""
            var len = 0
            var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
            if (autoLength) {
       ...
       * @__sig ipippp
       */
      function napi_create_bigint_words(
        env,
        sign_bit,
        word_count,
        words,
        ...
        try {
          ...
          value *=
            BigInt(sign_bit) % BigInt(2) === BigInt(0) ? BigInt(1) : BigInt(-1)
          result >>>= 0
      ...
      function emnapiCreateFunction(envObject, utf8name, length, cb, data) {
        ...
        var functionName =
          !utf8name || !length
            ? ""
            : emnapiString.UTF8ToString(utf8name, length)
        var f
      ...
      function emnapiDefineProperty(
        ...
        if (getter || setter) {
          ...
          var desc = {
            configurable:
              (attributes &
                4) /* napi_property_attributes.napi_configurable */ !==
              0,
            enumerable:
              (attributes &
                2) /* napi_property_attributes.napi_enumerable */ !==
              0,
            get: localGetter,
            set: localSetter,
          }
          ...
          var localMethod = emnapiCreateFunction(
            envObject,
            0,
            0,
            method,
          ...
          var desc = {
            ...
            enumerable:
              ...
              0,
            writable:
              (attributes & 1) /* napi_property_attributes.napi_writable */ !==
              0,
            value: localMethod,
          }
          Object.defineProperty(obj, propertyName, desc)
        ...
        try {
          ...
          for (var i = 0; i < property_count; i++) {
            ...
            if (utf8Name) {
              ...
              if (!name_1) {
                return envObject.setLastError(
                  4 /* napi_status.napi_name_expected */,
                )
              }
            ...
            if (
              (attributes & 1024) /* napi_property_attributes.napi_static */ !==
              0
            ) {
       ...
       * @__sig ipppp
       */
      function node_api_post_finalizer(
        env,
        finalize_cb,
        finalize_data,
        finalize_hint,
      ...
      function emnapi_create_memory_view(
        ...
        try {
          ...
          switch (typedarray_type) {
            ...
            default: /* napi_status.napi_invalid_arg */
              return envObject.setLastError(1)
          }
          var Ctor = viewDescriptor.Ctor
          var typedArray =
            typedarray_type === -2 /* emnapi_memory_view_type.emnapi_buffer */
          ...
          emnapiExternalMemory.wasmMemoryViewTable.set(
            typedArray,
            viewDescriptor,
          )
          if (finalize_cb) {
      ...
      function $emnapiGetMemoryAddress(arrayBufferOrView) {
        ...
        var info
        if (isArrayBuffer) {
          info = emnapiExternalMemory.getArrayBufferPointer(
            arrayBufferOrView,
            false,
          )
        } else {
       ...
       * @__sig ippp
       */
      function emnapi_get_external_sharedarraybuffer_handle(
        env,
        sharedarraybuffer,
        handle,
      ) {
      ...
      function $emnapiAcquireExternalSharedArrayBuffer(handle, sab) {
        ...
        if (sab == null) {
          ...
          new Uint8Array(sab).set(
            new Uint8Array(wasmMemory.buffer, external_data, meta.byte_length),
          )
        } else {
       ...
       * @__sig ipppp
       */
      function node_api_create_sharedarraybuffer(
        env,
        byte_length,
        data,
        result,
       ...
       * @__sig ipppppp
       */
      function node_api_create_external_sharedarraybuffer(
        env,
        external_data,
        byte_length,
        finalize_cb,
        ...
        try {
          ...
          if (finalize_cb) {
            finalize_cb >>>= 0
            finalize_hint >>>= 0
            var metaPtr = emnapiExternalSAB.allocMeta(
              external_data,
              byte_length,
              finalize_cb,
              external_data,
       ...
       * @__sig ipppppp
       */
      function node_api_create_object_with_properties(
        env,
        prototype_or_null,
        property_names,
        property_values,
        ...
        for (var i = 0; i < property_count; i++) {
          ...
          if (
            !(typeof name_value === "string" || typeof name_value === "symbol")
          )
            return envObject.setLastError(
              4 /* napi_status.napi_name_expected */,
            )
          properties[name_value] = {
            value: emnapiCtx.handleStore.get(
              HEAP_DATA_VIEW.getUint32(property_values + i * 4, true),
            ).value,
            writable: true,
            enumerable: true,
            configurable: true,
        ...
        try {
          obj = Object.defineProperties(
            Object.create(v8_prototype_or_null),
            properties,
          )
        } catch (_) {
          return envObject.setLastError(
      ...
      function napi_create_typedarray(
        ...
        try {
          ...
          if (
            ...
            emnapiExternalMemory.isSharedArrayBuffer(buffer)
          ) {
            switch (type) {
        ...
        try {
          ...
          if (!data || size === 0) {
            ...
            var viewDescriptor = {
              ...
              address: pointer,
              length: size,
              ownership: emnapiExternalMemory.registry
                ? 0 /* ReferenceOwnership.kRuntime */
                : 1 /* ReferenceOwnership.kUserland */,
              runtimeAllocated: 1,
            }
      ...
      function napi_create_buffer_copy(env, length, data, result_data, result) {
        ...
        try {
          ...
          length >>>= 0
          buffer.set(
            new Uint8Array(wasmMemory.buffer).subarray(data, data + length),
          )
          value = emnapiCtx.addToCurrentScope(buffer).id
          result >>>= 0
          var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
      ...
      function napi_create_external_buffer(
        ...
        return emnapi_create_memory_view(
          env,
          -2 /* emnapi_memory_view_type.emnapi_buffer */,
          data,
          length,
          finalize_cb,
          finalize_hint,
      ...
      function napi_create_dataview(
        ...
        try {
          ...
          if (
            ...
            emnapiExternalMemory.isSharedArrayBuffer(value)
          ) {
      ...
      function node_api_symbol_for(env, utf8description, length, result) {
        ...
        var descriptionString = emnapiString.UTF8ToString(
          utf8description,
          length,
        )
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        var value = emnapiCtx.addToCurrentScope(
          Symbol.for(descriptionString),
        ).id
        var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
        HEAP_DATA_VIEW.setUint32(result, value, true)
        return envObject.clearLastError()
      ...
      function napi_get_boolean(env, value, result) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        var v =
          value === 0 ? 3 /* GlobalHandle.FALSE */ : 4 /* GlobalHandle.TRUE */
        var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
        HEAP_DATA_VIEW.setUint32(result, v, true)
        return envObject.clearLastError()
      }
      ...
      /** @__sig ipppppp */
      function _emnapi_create_function(
        env,
        utf8name,
        length,
        cb,
      ...
      function napi_create_function(env, utf8name, length, cb, data, result) {
        ...
        try {
          ...
          if (!cb)
            return envObject.setLastError(1 /* napi_status.napi_invalid_arg */)
          return _emnapi_create_function(
            env,
            utf8name,
            length,
            cb,
      ...
      function napi_escape_handle(env, scope, escapee, result) {
        ...
        return envObject.setLastError(
          12 /* napi_status.napi_escape_called_twice */,
        )
      }
      /** @__sig ippip */
      function napi_create_reference(env, value, initial_refcount, result) {
        ...
        if (envObject.moduleApiVersion < 10) {
          if (
            !(handle.isObject() || handle.isFunction() || handle.isSymbol())
          ) {
            return envObject.setLastError(1 /* napi_status.napi_invalid_arg */)
          }
        }
      ...
      function napi_get_all_property_names(
        ...
        try {
          ...
          if (
            key_mode !==
              0 /* napi_key_collection_mode.napi_key_include_prototypes */ &&
            key_mode !== 1 /* napi_key_collection_mode.napi_key_own_only */
          ) {
            return envObject.setLastError(1 /* napi_status.napi_invalid_arg */)
          }
          if (
            key_conversion !==
              0 /* napi_key_conversion.napi_key_keep_numbers */ &&
            key_conversion !==
              1 /* napi_key_conversion.napi_key_numbers_to_strings */
          ) {
            return envObject.setLastError(1 /* napi_status.napi_invalid_arg */)
          }
          var props = []
          ...
          do {
            ...
            for (i = 0; i < names.length; i++) {
              props.push({
                name: integerIndiceRegex.test(names[i])
                  ? Number(names[i])
                  : names[i],
          ...
          var addName = function (ret, name, key_filter, conversion_mode) {
            ...
            if (
              ...
              if (typeof realName === "string") {
                if (
                  !(
                    (key_filter & 8) /* napi_key_filter.napi_key_skip_strings */
                  )
                ) {
                  ret.push(realName)
                }
          ...
          for (i = 0; i < props.length; i++) {
            ...
            var desc = prop.desc
            if (
              key_filter === 0 /* napi_key_filter.napi_key_all_properties */
            ) {
              ...
              if (
                key_filter & 16 /* napi_key_filter.napi_key_skip_symbols */ &&
                typeof name_1 === "symbol"
              ) {
                continue
              }
              var shouldAdd = true
              switch (key_filter & 7) {
                ...
                case 1 /* napi_key_filter.napi_key_writable */ |
                  2 /* napi_key_filter.napi_key_enumerable */: {
                ...
                case 4 /* napi_key_filter.napi_key_configurable */ |
                  1 /* napi_key_filter.napi_key_writable */: {
      ...
      function napi_get_property_names(env, object, result) {
        return napi_get_all_property_names(
          ...
          0 /* napi_key_collection_mode.napi_key_include_prototypes */,
          2 /* napi_key_filter.napi_key_enumerable */ |
            16 /* napi_key_filter.napi_key_skip_symbols */,
          1 /* napi_key_conversion.napi_key_numbers_to_strings */,
          result,
        )
      }
      ...
      function napi_has_own_property(env, object, key, result) {
        ...
        try {
          ...
          r = Object.prototype.hasOwnProperty.call(
            v,
            emnapiCtx.handleStore.get(key).value,
          )
          result >>>= 0
          var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
          HEAP_DATA_VIEW.setInt8(result, r ? 1 : 0, true)
      ...
      function napi_instanceof(env, object, constructor, result) {
        ...
        try {
          ...
          if (!ctor.isFunction()) {
            return envObject.setLastError(
              5 /* napi_status.napi_function_expected */,
            )
          }
      ...
      function node_api_is_sharedarraybuffer(env, value, result) {
        ...
        var r =
          ...
          Object.prototype.toString.call(h.value) ===
            "[object SharedArrayBuffer]"
            ? 1
            : 0
        var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
      ...
      function napi_detach_arraybuffer(env, arraybuffer) {
        ...
        if (!(value instanceof ArrayBuffer)) {
          if (
            ...
            return envObject.setLastError(
              20 /* napi_status.napi_detachable_arraybuffer_expected */,
            )
          }
          return envObject.setLastError(
            19 /* napi_status.napi_arraybuffer_expected */,
          )
        }
        try {
          var MessageChannel_1 = emnapiCtx.feature.MessageChannel
      ...
      napiModule.emnapi.acquireExternalSharedArrayBuffer =
        $emnapiAcquireExternalSharedArrayBuffer
      ...
      napiModule.imports.napi.napi_create_threadsafe_function =
        napi_create_threadsafe_function
      napiModule.imports.napi.napi_get_threadsafe_function_context =
        napi_get_threadsafe_function_context
      napiModule.imports.napi.napi_call_threadsafe_function =
        napi_call_threadsafe_function
      napiModule.imports.napi.napi_acquire_threadsafe_function =
        napi_acquire_threadsafe_function
      napiModule.imports.napi.napi_release_threadsafe_function =
        napi_release_threadsafe_function
      napiModule.imports.napi.napi_unref_threadsafe_function =
        napi_unref_threadsafe_function
      napiModule.imports.napi.napi_ref_threadsafe_function =
        ...
        _super.call(
          ...
          __assign(__assign({}, options), {
            onError: function (err, type) {
              var _a
              var emnapi_thread_crashed =
                (_a = _this.instance) === null || _a === void 0
                  ? void 0
                  : _a.exports.emnapi_thread_crashed
