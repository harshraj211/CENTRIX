...
exports.asyncifyLoadSync =
  exports.loadSync =
  exports.asyncifyLoad =
  exports.load =
    void 0
...
function load(wasmInput, imports) {
  ...
  if (
    wasmInput instanceof
    webassembly_1._WebAssembly.Module
  ) {
    return webassembly_1._WebAssembly
  ...
  if (
    typeof webassembly_1._WebAssembly.instantiateStreaming ===
    "function"
  ) {
    let responsePromise
    try {
      responsePromise = fetch(wasmInput)
      source = webassembly_1._WebAssembly
