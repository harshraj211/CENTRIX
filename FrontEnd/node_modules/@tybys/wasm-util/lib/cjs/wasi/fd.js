...
exports.AsyncTable =
  exports.SyncTable =
  exports.FileDescriptorTable =
  exports.toFileStat =
  exports.toFileType =
  exports.StandardOutput =
  exports.FileDescriptor =
  exports.concatBuffer =
    void 0
...
class FileDescriptor {
  ...
  seek(offset, whence) {
    if (
      whence ===
      types_1.WasiWhence.SET
    ) {
      this.pos = BigInt(offset)
    } else if (
      whence ===
      types_1.WasiWhence.CUR
    ) {
      this.pos += BigInt(offset)
    } else if (
      whence ===
      types_1.WasiWhence.END
    ) {
      this.pos =
        BigInt(this.size) -
        BigInt(offset)
...
class FileDescriptorTable {
  ...
  insertStdio(fd, expected, name) {
    ...
    const { base, inheriting } = (0, rights_1.getRights)(
      this.stdio,
      fd,
    ...
    if (
      ...
      throw new error_1.WasiError(
        `id: ${wrap.id} !== expected: ${expected}`,
        types_1.WasiErrno.EBADF,
      )
    }
    return wrap
  }
