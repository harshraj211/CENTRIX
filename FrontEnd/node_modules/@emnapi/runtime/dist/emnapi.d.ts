...
export declare type FunctionPointer<T extends (
  ...args: any[]
) => any,> = Pointer<T>
...
export declare type CleanupHookCallbackFunction = number | ((
  arg: number,
) => void)
...
export declare class Context {
  ...
  createNotSupportWeakRefError(
    api: string,
    message: string,
  ): NotSupportWeakRefError

  createNotSupportBufferError(
    api: string,
    message: string,
  ...
  addCleanupHook(
    envObject: Env,
    fn: CleanupHookCallbackFunction,
    arg: number,
  ): void
...
export declare const NAPI_VERSION_EXPERIMENTAL =
...
export declare const NODE_API_SUPPORTED_VERSION_MAX =
  Version.NODE_API_SUPPORTED_VERSION_MAX

export declare const NODE_API_SUPPORTED_VERSION_MIN =
  Version.NODE_API_SUPPORTED_VERSION_MIN
...
export declare class NodeEnv extends Env {
  ...
  callbackIntoModule<T,>(
    enforceUncaughtExceptionPolicy: boolean,
    fn: (env: Env) => T,
  ): T
